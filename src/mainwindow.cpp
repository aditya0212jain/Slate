...
void MainWindow::on_openAct_triggered()
{
    ...
    for(int i=0;i<num_faces;i++){
        ...
        cout<<"face x :"<<f_new[i]->p[0]->x<<","<<f_new[i]->p[0]->y<<","<<f_new[i]->p[0]->z<<endl;
...
void MainWindow::on_actionConvert_2D_triggered()
{
    ...
    plane* p_new;
    cout<<"mm nf: "<<mm->nf<<endl;
    p_new = new plane[mm->nf];
    ...
    getVertex2D(0);     // converting the vertices in tvg
    getVertex2D(1);     // converting the vertices in fvg
    getVertex2D(2);     // converting the vertices in svg

    for(int i=0;i<mm->nv;i++){
        cout<<"topview vertices : "<<tvg->v[i]->x<<","<<tvg->v[i]->y<<","<<tvg->v[i]->id<<endl;
    }
    ...
    for(int i=0;i<tvg->s;i++){
        cout<<"topview edges : "<<tvg->e[i].a->id<<","<<tvg->e[i].b->id<<endl;
        cout<<tvg->e[i].a->id<<","<<tvg->e[i].a->x<<","<<tvg->e[i].a->y<<endl;

        cout<<tvg->e[i].b->id<<","<<tvg->e[i].b->x<<","<<tvg->e[i].b->y<<endl;
    }
    for(int i=0;i<tvg->h;i++){
        cout<<"topview edges : "<<tvg->hidden_edge[i].a->id<<","<<tvg->hidden_edge[i].b->id<<endl;
        cout<<tvg->hidden_edge[i].a->id<<","<<tvg->hidden_edge[i].a->x<<","<<tvg->hidden_edge[i].a->y<<endl;

        cout<<tvg->hidden_edge[i].b->id<<","<<tvg->hidden_edge[i].b->x<<","<<tvg->hidden_edge[i].b->y<<endl;
    }
