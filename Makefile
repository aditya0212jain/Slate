...
INCPATH += -Iinclude -Ilibs/Qt5.7.0/5.7/gcc_64/include -Ilibs/Qt5.7.0/5.7/gcc_64/include/QtWidgets -Ilibs/Qt5.7.0/5.7/gcc_64/include/QtGui -Ilibs/Qt5.7.0/5.7/gcc_64/include/QtCore -I./libs/Eigen -Ilibs/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++ -Iinclude/GL 
CFLAGS += -Wall
...
moc_mainwindow.cpp: ./include/mainwindow.h
	./libs/Qt5.7.0/5.7/gcc_64/bin/moc $(DEFINE) $(INCPATH) -I/usr/include/c++/5 -I/usr/include/x86_64-linux-gnu/c++/5 -I/usr/include/c++/5/backward -I/usr/lib/gcc/x86_64-linux-gnu/5/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/5/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include ./include/mainwindow.h -o $(SRC_DIR)/moc_mainwindow.cpp

ui_mainwindow.h:./src/mainwindow.ui
	./libs/Qt5.7.0/5.7/gcc_64/bin/uic ./src/mainwindow.ui -o ./include/ui_mainwindow.h
