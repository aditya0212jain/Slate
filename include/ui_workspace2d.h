...
public:
    ...
    {
        workspace2D->setWindowTitle(QApplication::translate("workspace2D", "MainWindow", 0));
        actionNew->setText(QApplication::translate("workspace2D", "New", 0));
        actionFront_View->setText(QApplication::translate("workspace2D", "Front View", 0));
        actionTop_View->setText(QApplication::translate("workspace2D", "Top View", 0));
        actionSide_View->setText(QApplication::translate("workspace2D", "Side View", 0));
        actionSave->setText(QApplication::translate("workspace2D", "Save", 0));
        actionExit->setText(QApplication::translate("workspace2D", "Exit", 0));
        actionConvert_to_3D->setText(QApplication::translate("workspace2D", "Convert to 3D", 0));
        actionAbout_Slate->setText(QApplication::translate("workspace2D", "About Slate", 0));
        actionVersion_Information->setText(QApplication::translate("workspace2D", "Version Information", 0));
        label_11->setText(QApplication::translate("workspace2D", "Add Vertex", 0));
        pushButton_11->setText(QApplication::translate("workspace2D", "Create", 0));
        label_12->setText(QApplication::translate("workspace2D", "Add Edge", 0));
        pushButton_12->setText(QApplication::translate("workspace2D", "Create", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("workspace2D", "Tab 1", 0));
        label_5->setText(QApplication::translate("workspace2D", "Add Vertex", 0));
        pushButton->setText(QApplication::translate("workspace2D", "Create", 0));
        label_6->setText(QApplication::translate("workspace2D", "Add Edge", 0));
        pushButton_6->setText(QApplication::translate("workspace2D", "Create", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("workspace2D", "Tab 2", 0));
        tabWidget_2->setTabText(tabWidget_2->indexOf(front), QApplication::translate("workspace2D", "Front", 0));
        tabWidget_2->setTabText(tabWidget_2->indexOf(top), QApplication::translate("workspace2D", "Top", 0));
        tabWidget_2->setTabText(tabWidget_2->indexOf(side), QApplication::translate("workspace2D", "Side", 0));
        label->setText(QApplication::translate("workspace2D", "Transformations", 0));
        label_2->setText(QApplication::translate("workspace2D", "Translate", 0));
        pushButton_2->setText(QApplication::translate("workspace2D", "Apply", 0));
        label_3->setText(QApplication::translate("workspace2D", "Scale", 0));
        pushButton_3->setText(QApplication::translate("workspace2D", "Apply", 0));
        label_4->setText(QApplication::translate("workspace2D", "Rotate", 0));
        pushButton_4->setText(QApplication::translate("workspace2D", "Apply", 0));
        pushButton_5->setText(QApplication::translate("workspace2D", "Apply All", 0));
        menuFile->setTitle(QApplication::translate("workspace2D", "File", 0));
        menuOpen->setTitle(QApplication::translate("workspace2D", "Open..", 0));
        menuEdit->setTitle(QApplication::translate("workspace2D", "Edit", 0));
        menuHelp->setTitle(QApplication::translate("workspace2D", "Help", 0));
        toolBar->setWindowTitle(QApplication::translate("workspace2D", "toolBar", 0));
    } // retranslateUi
